        ...
        <div className="contact__group">
          <div className="contact__options">
            <article className="contact__option">
              ...
              <h3>Email</h3>
              <h5>thrishakumar45@gmail.com</h5>
              <a href="mailto:thrishakumar45@gmail.com" target='_blank' className='btn'>Send a  message</a>
            </article>
            <article className="contact__option">
              <RiMessengerLine className='contact__icon'/>
              <h3>Messenger</h3>
              <h5>Thrisha Dev Coder</h5>
            ...
            <article className="contact__option">
              ...
              <h3>WhatsApp</h3>
              <h5>+919025522748</h5>
              <a href="https://api.whatsapp.com/send?phone=+919025522748" target='_blank' className='btn'>Send a  message</a>
            </article>
          </div>
